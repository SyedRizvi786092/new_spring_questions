...
import com.example.EventManagment.service.EventServiceImpl;
...
import com.example.EventManagment.dto.PurchaseDTO;
import com.example.EventManagment.dto.PurchaseResponseDTO;
import com.example.EventManagment.dto.RequestDto;
import com.example.EventManagment.dto.ResponseDto;
import com.example.EventManagment.exception.InvalidDateFormatExcption;
...
//        this.eventServiceImpl = eventServiceImpl;
    ...
    public ResponseEntity<List<ResponseDto>> upcoming(
    	...
    	try {
    		LocalDate start = LocalDate.parse(endDate, formatter);
    		LocalDate end = LocalDate.parse(endDate, formatter);
    		
    		return new ResponseEntity<List<ResponseDto>>( service.upcomingEvents(start, end), HttpStatus.OK);
    		
    	}catch(Exception e) {
    		throw new InvalidDateFormatExcption("Invalid date format");
    	}
    	
    }
    
    public ResponseEntity<PurchaseResponseDTO> purchase(@RequestBody PurchaseDTO purchaseDTO){
//		return new ResponseEntity<PurchaseResponseDTO>();
